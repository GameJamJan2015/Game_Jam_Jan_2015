...
public abstract class Light implements Disposable {
	 ...
	 */
	public abstract void attachToBody(GameEntity body);
	
	/**
	 * @return attached body or {@code null}
	 * 
	 * @see #attachToBody(GameEntity, float, float)
	 */
	public abstract GameEntity getBody();

	/**
	 * Sets light starting position
	 * 
	 * @see #setPosition(com.badlogic.gdx.math.Vector2)
	 */
	 ...
	 * 
	 * @see #setColor(com.badlogic.gdx.graphics.Color)
	 */
