...
public class RayHandler implements Disposable {
	 ...
	 * 
	 * @see #setCombinedMatrix(com.badlogic.gdx.math.Matrix4)
	 * @see #setCombinedMatrix(com.badlogic.gdx.math.Matrix4, float, float, float, float)
	 */
	 ...
	 * {@link #setCombinedMatrix(com.badlogic.gdx.math.Matrix4, float, float, float, float)} instead
	 * 
	 * @param combined
	 *            matrix that include projection and translation matrices
	 * 
	 * @see #setCombinedMatrix(com.badlogic.gdx.graphics.OrthographicCamera)
	 * @see #setCombinedMatrix(com.badlogic.gdx.math.Matrix4, float, float, float, float)
	 */
	 ...
	 * 
	 * @see #setAmbientLight(com.badlogic.gdx.graphics.Color)
