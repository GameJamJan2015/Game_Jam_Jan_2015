...
public abstract class PositionalLight extends Light {
	...
	@Override
	public void attachToBody(GameEntity body) {
	 ...
	 * 
	 */
	public void attachToBody(GameEntity body, float offsetX, float offsetY) {
	 ...
	 */
	public void attachToBody(GameEntity body, float offsetX, float offSetY, float degrees) {
		this.body = body;
		bodyOffsetX = offsetX;
		bodyOffsetY = offSetY;
